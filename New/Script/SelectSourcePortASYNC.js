function SelectSourcePort(SlotNum, PortID)
{
  ...
  if(ShelfType == 3500)
  {
   ...
   if (SlotNum == 1) 
    ...
    if (SlotNum == 4) 
    {SlotObj = Aliases.VNMS.HwndSource_MappingScreen.MappingScreen.BusyIndicator.Grid.ContentGrid.MappingScrollViewer.Grid.Grid.FirstNode.FirstNodeViewBox.FirstNodeView.MappingNode3500.Grid.Border.Grid.SlotArea.Slot4.FindChild(PropertyNames, PropertyValues, 6);
    SlotObj.ClickR(30,20);
    SlotObj.FindChild("ClrFullClassName","RFL.PortGrid",2).PopupMenu.Click("Map this port");
    }
    if (SlotNum == 5) 
