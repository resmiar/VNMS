function SelectSourcePort(SlotNum, PortID)
{
  ...
  if(ShelfType == 3500)
  {
   ...
   if (SlotNum == 1) 
    ...
    SlotObj.ClickR();
    SlotObj.FindChild("WPFControlName","T1E1Grid",5).PopupMenu.Click("Delete this Bundle");
    }
    if (SlotNum == 2) 
    ...
    mappingBorder.PopupMenu.Click("Delete this Bundle");
    }
  }
  if(ShelfType == "3500M")
  {
   ...
   if (SlotNum == 1) 
    ...
    border.BdrT1E1.PopupMenu.Click("Delete this Bundle");
    }
  } 
}